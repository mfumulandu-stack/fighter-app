...
function ImpressumScreen({onClose}){
  const S={bg:'#f5f5f7',card:'#fff',text:'#1a1a1a',sub:'#555',border:'#eee',red:'#c0392b'};
  const Row=({title,children})=>(<div style={{marginBottom:16}}><div style={{fontWeight:700,color:S.text,fontSize:13,marginBottom:6,borderLeft:'3px solid '+S.red,paddingLeft:8}}>{title}</div><div style={{color:S.sub,fontSize:13,lineHeight:1.8}}>{children}</div></div>);
  return(
    <div style={{position:'fixed',inset:0,background:S.bg,zIndex:300,overflowY:'auto',padding:'20px 16px 40px'}}>
      <div style={{maxWidth:480,margin:'0 auto'}}>
        <button onClick={onClose} style={{background:'none',border:'none',color:S.red,fontSize:20,cursor:'pointer',marginBottom:16,fontFamily:'Rajdhani,sans-serif',fontWeight:700}}>← Zurück</button>
        <div style={{background:S.card,borderRadius:14,padding:'20px',border:'1px solid '+S.border}}>
          <div style={{fontFamily:'Rajdhani,sans-serif',fontWeight:700,fontSize:22,color:S.text,letterSpacing:2,marginBottom:4}}>IMPRESSUM</div>
          <div style={{color:S.red,fontSize:10,letterSpacing:2,marginBottom:20}}>Angaben gemäß § 5 TMG</div>
          <Row title="Betreiber">Junior Landu Mfumu<br/>Ottostraße 43<br/>52070 Aachen<br/>Deutschland</Row>
          <Row title="Kontakt">E-Mail: mfumulandu@gmail.com<br/><span style={{color:'#aaa',fontSize:11}}>Antwortzeit: innerhalb von 5 Werktagen</span></Row>
          <Row title="Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV">Junior Landu Mfumu, Ottostraße 43, 52070 Aachen</Row>
          <Row title="Haftungsausschluss">Die Inhalte dieser App wurden mit größter Sorgfalt erstellt. Als Diensteanbieter sind wir gemäß § 7 Abs. 1 TMG für eigene Inhalte verantwortlich. Nach §§ 8–10 TMG sind wir nicht verpflichtet, übermittelte fremde Informationen zu überwachen.</Row>
          <Row title="Haftung für Links">Unser Angebot enthält Links zu externen Websites Dritter. Für deren Inhalte übernehmen wir keine Haftung, da wir keinen Einfluss darauf haben.</Row>
          <Row title="Urheberrecht">Die durch den Betreiber erstellten Inhalte unterliegen dem deutschen Urheberrecht. Vervielfältigung oder Verbreitung bedarf der schriftlichen Zustimmung des Autors.</Row>
          <Row title="Online-Streitbeilegung">EU-Plattform: https://ec.europa.eu/consumers/odr<br/>Wir nehmen nicht an Verbraucherstreitbeilegungsverfahren teil.</Row>
  ...
  return(
    <div style={{position:'fixed',inset:0,background:S.bg,zIndex:300,overflowY:'auto',padding:'20px 16px 40px'}}>
      <div style={{maxWidth:480,margin:'0 auto'}}>
        <button onClick={onClose} style={{background:'none',border:'none',color:S.red,fontSize:20,cursor:'pointer',marginBottom:16,fontFamily:'Rajdhani,sans-serif',fontWeight:700}}>← Zurück</button>
        <div style={{background:S.card,borderRadius:14,padding:'20px',border:'1px solid '+S.border}}>
          <div style={{fontFamily:'Rajdhani,sans-serif',fontWeight:700,fontSize:22,color:S.text,letterSpacing:2,marginBottom:4}}>DATENSCHUTZ</div>
          <div style={{color:S.red,fontSize:10,letterSpacing:2,marginBottom:20}}>Datenschutzerklärung gemäß DSGVO</div>
          <Row title="1. Verantwortlicher">Junior Landu Mfumu, Ottostraße 43, 52070 Aachen. Kontakt: mfumulandu@gmail.com</Row>
          <Row title="2. Erhobene Daten">E-Mail-Adresse, Name, Alter, Stadt, Gym, Kampfstil, Profilbild, Nachrichten, Swipes und Matches.</Row>
          <Row title="3. Zweck der Verarbeitung">Bereitstellung der App, Matching zwischen Nutzern, Chat-Funktion, Gym-Verzeichnis und Ranglisten.</Row>
          <Row title="4. Datenweitergabe">Keine Weitergabe an Dritte. Technische Dienstleister: Supabase (Datenbank), Vercel (Hosting), Resend (E-Mail).</Row>
          <Row title="5. Datenspeicherung">Daten werden auf EU-Servern von Supabase gespeichert. Nachrichten werden nach 90 Tagen Inaktivität gelöscht.</Row>
          <Row title="6. Deine Rechte">Auskunft, Berichtigung, Löschung, Datenportabilität und Widerspruch. Account-Löschung direkt in der App unter Profil → Einstellungen.</Row>
          <Row title="7. Cookies">Keine Tracking-Cookies. Nur technisch notwendiger localStorage für die Session.</Row>
          <Row title="8. Minderjährige">Die App richtet sich ausschließlich an Personen ab 18 Jahren.</Row>
          <Row title="9. Kontakt">mfumulandu@gmail.com</Row>
          <div style={{color:'#aaa',fontSize:10,textAlign:'center',marginTop:8}}>Stand: Mai 2026</div>
        </div>
      </div>
    </div>
  ...
  return(
    <div style={{position:'fixed',inset:0,background:S.bg,zIndex:300,overflowY:'auto',padding:'20px 16px 40px'}}>
      <div style={{maxWidth:480,margin:'0 auto'}}>
        <button onClick={onClose} style={{background:'none',border:'none',color:S.red,fontSize:20,cursor:'pointer',marginBottom:16,fontFamily:'Rajdhani,sans-serif',fontWeight:700}}>← Zurück</button>
        <div style={{background:S.card,borderRadius:14,padding:'20px',border:'1px solid '+S.border}}>
          <div style={{fontFamily:'Rajdhani,sans-serif',fontWeight:700,fontSize:22,color:S.text,letterSpacing:2,marginBottom:4}}>AGB</div>
          <div style={{color:S.red,fontSize:10,letterSpacing:2,marginBottom:20}}>Allgemeine Geschäftsbedingungen</div>
          <Row title="1. Leistungsumfang">Die App bietet: Kampfsport-Profil, Matching (Swipe-System), Chat zwischen Matches, Gym-Suche und Bewertungen, Ranglisten. Kein Anspruch auf dauerhaften Betrieb.</Row>
          <Row title="2. Nutzungsbedingungen">Die Nutzung ist ab 18 Jahren gestattet. Nutzer sind verantwortlich für ihre Inhalte. Beleidigungen, Spam oder illegale Inhalte führen zur Sperrung.</Row>
          <Row title="3. Haftung">Der Betreiber haftet nicht für Schäden aus der Nutzung der App, aus Treffen zwischen Nutzern oder aus Fehlinformationen in Profilen.</Row>
          <Row title="4. Verantwortung bei Treffen">Treffen zwischen Nutzern erfolgen auf eigene Verantwortung. Der Betreiber übernimmt keine Haftung für physische Schäden.</Row>
          <Row title="5. Kündigung">Nutzer können ihr Konto jederzeit unter Profil → Einstellungen → Account löschen kündigen. Der Betreiber kann Accounts bei Verstößen sperren.</Row>
          <Row title="6. Änderungen">Der Betreiber behält sich vor, diese AGB jederzeit zu ändern. Nutzer werden über wesentliche Änderungen informiert.</Row>
          <Row title="7. Geltendes Recht">Es gilt deutsches Recht. Gerichtsstand ist Aachen.</Row>
          <div style={{color:'#aaa',fontSize:10,textAlign:'center',marginTop:8}}>Stand: Mai 2026</div>
        </div>
      </div>
    </div>
